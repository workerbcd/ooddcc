...
if args.score in ["ReAct", "DICEOOD", "VRA", "Line",'FDB']:
...
ood_names = [NAMES[name.lower()] for name in args.ood_dsets]
fig_names = ['imagenet'] + ood_names
fig_scores = [id_scores]
