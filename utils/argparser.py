...
class BaseArgs():
    ...
    def __init__(self) -> None:
        ...
        # ------------------- Datasets
        self.parser.add_argument('--id_dset', type=str, default="imagenet",
        ...
        self.parser.add_argument('--scoreform', type=str, default='norm', help='det or norm')
        self.parser.add_argument('--aug_index', type=int, default=None)
    def preprocess_args(self, args):
        ...
        if args.id_dset == "imagenet":
            ...
            args.id_train_size_total = 50000
...
class FeatExtractArgs(BaseArgs):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--id_train_num', type=int, default=2000000,
    ...
    def preprocess_args(self, args):
        ...
        if 'CIFAR' in args.id_dset:
            args.id_train_num = 200000
        # if 'supcon' in args.arch:
        #     args.id_train_num = 200000
        return args
...
class OODArgs(FeatExtractArgs):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--score',type=str, default='MSP', 
                            ...
                            # "MahaVanilla",
                            # "ReAct",
                            # "KNN", "VIM", "Residual","MYOOD","RDCluster"],
                            help="score type.")
        ...
        self.parser.add_argument('--sample_ratio', type=float, default=1.0)
        self.parser.add_argument('--residual_dim', type=int, default=None,help='use for set residual dim in ablation')
        self.parser.add_argument('--neco_dim', type=int, default=512, help='design for neco')
        self.parser.add_argument('--ablation_num', type=int, default=None, help='use for ablation of id num')
